import {
  defaultLocalInformation, defaultPhysics, defaultRemoteInformation,
...
export class ParticipantBase extends MapObject {
  @observable id = ''
  @observable zIndex = 0
  ...
  constructor(isLocal=false) {
    super()
    if (isLocal){
      this.information_ = defaultLocalInformation
      // this.information = defaultLocalInformation
    }else{
